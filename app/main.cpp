...
int main(int argc, char *argv[]) {
  ...
  qmlRegisterType<SqlWordsEditModel>("io.github.damaxi", 1, 0,
                                     "WordsEditModel");
  qmlRegisterType<SqlVocabularyQueryModel>("io.github.damaxi", 1, 0,
                                           "VocabulariesQueryModel");
  qmlRegisterType<SqlLearningWordsModel>("io.github.damaxi", 1, 0,
                                         "WordsLearningModel");
  qmlRegisterType<SqlVocabularyEditModel>("io.github.damaxi", 1, 0,
                                          "VocabulariesEditModel");
  qmlRegisterType<StatisticChartModel>("io.github.damaxi", 1, 0,
                                       "StatisticChartModel");
  qmlRegisterType<LocaleModel>("io.github.damaxi", 1, 0, "LocaleModel");
  qmlRegisterType<DateHelper>("io.github.damaxi", 1, 0, "DateHelper");
  qmlRegisterType<Translate>("io.github.damaxi", 1, 0, "Translate");
  //    QSettings settings;
